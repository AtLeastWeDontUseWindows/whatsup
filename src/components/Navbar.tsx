...
import { signInWithGoogle, logout, auth, loading } from '../utility/firebase';
...
const Navbar: Component = () => {
  ...
  const getLoadingState = (uid: string) => {
    if (loading()) {
      return (
        <button class="bg-rose-500 hover:bg-blue-700 text-white font-bold py-2 px-8 rounded">
          <div role="status">
            <svg class="inline mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-white fill-gray-600 dark:fill-rose-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
